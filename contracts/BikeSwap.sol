...
/*
BikeSwap (C) Copyright 2019 Seena Zandipour. All Rights Reserved.
*/
contract BikeSwap {
    ...
    function submitFeedback(address _account, uint _score, string memory _message) public {
        ...
        emit SubmitFeedback(msg.sender, _account,now, _score, _message);
    }
